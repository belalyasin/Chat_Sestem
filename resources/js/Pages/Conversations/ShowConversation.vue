<script>
// import ContentLayouts from '../../Layouts/Content.vue';
export default {
    // components: {
    //     ContentLayouts
    // },
    ...
    <div class="h-full flex flex-col">
        <div class="flex flex-col sm:flex-row border-b border-gray-200 px-5 py-4">
            <div class="flex items-center">
                ...
                <div class="ml-3 mr-auto">
                    <div class="font-medium text-base">
                        ...
                        <!-- '' ?
                            conversation.name : conversation.users.map(user => user.name).join(', ') -->
                    </div>
            ...
            <div
                ...
                <a href="javascript:;" class="w-5 h-5 text-gray-500"> <i data-feather="search" class="w-5 h-5"></i>
                </a>
                <a href="javascript:;" class="w-5 h-5 text-gray-500 ml-5"> <i data-feather="user-plus"
                        class="w-5 h-5"></i> </a>
        ...
        <div class="overflow-y-scroll px-5 pt-5 flex-1">
            <div class="chat__box__text-box flex items-end float-left mb-4">
                ...
                <div class="hidden sm:block dropdown relative ml-3 my-auto">
                    <a href="javascript:;" class="dropdown-toggle w-4 h-4 text-gray-500"> <i
        ...
        <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200">
            ...
            <div class="flex absolute sm:static left-0 bottom-0 ml-5 sm:ml-0 mb-5 sm:mb-0">
                <div class="dropdown relative mr-3 sm:mr-5">
                    <a href="javascript:;" class="dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block text-gray-500"> <i
                            data-feather="smile" class="w-full h-full"></i> </a>
                            ...
                            <div class="chat-dropdown__box box flex flex-col pb-3 -mt-2">
                                <div class="px-3 pt-3">
                                    <div class="relative text-gray-700">
                                        <input type="text" class="input w-full bg-gray-200 pr-10 placeholder-theme-13"
                                ...
                                <div class="chat-dropdown__box__tabs nav-tabs flex px-3 mt-5">
                                    <a data-toggle="tab" data-target="#history" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                    ...
                                    <a data-toggle="tab" data-target="#smile" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200 active">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 496 512">
                                            <path fill="currentColor"
                                    ...
                                    <a data-toggle="tab" data-target="#cat" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512">
                                            <path fill="currentColor"
                                    ...
                                    <a data-toggle="tab" data-target="#coffee" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 640 512">
                                            <path fill="currentColor"
                                    ...
                                    <a data-toggle="tab" data-target="#futbol" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512">
                                            <path fill="currentColor"
                                    ...
                                    <a data-toggle="tab" data-target="#building" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 448 512">
                                            <path fill="currentColor"
                                    ...
                                    <a data-toggle="tab" data-target="#lightbulb" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 352 512">
                                            <path fill="currentColor"
                                    ...
                                    <a data-toggle="tab" data-target="#music" href="javascript:;"
                                        class="py-2 flex justify-center flex-1 rounded hover:bg-gray-200">
                                        <svg class="w-4 h-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512">
                                            <path fill="currentColor"
                                    ...
                                    <div class="h-full tab-content__pane active" id="smile">
                                        ...
                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                            <div class="grid grid-cols-8 text-2xl">
                                                ...
                                                <button class="rounded focus:outline-none hover:bg-gray-200">👵</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;⚕️</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👩&zwj;⚕️</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;🎓</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👩&zwj;🎓</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;🏫</button>
                                                ...
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👮&zwj;♀️</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">🕵️</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">🕵️&zwj;♂️</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">🕵️&zwj;♀️</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">💂</button>
                                                <button
                                                ...
                                                <button class="rounded focus:outline-none hover:bg-gray-200">💏</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👩&zwj;❤️&zwj;💋&zwj;👨</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;❤️&zwj;💋&zwj;👨</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👩&zwj;❤️&zwj;💋&zwj;👩</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">💑</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👩&zwj;❤️&zwj;👨</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;❤️&zwj;👨</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👩&zwj;❤️&zwj;👩</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">👪</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;👩&zwj;👦</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;👩&zwj;👧</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;👩&zwj;👧&zwj;👦</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;👩&zwj;👦&zwj;👦</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">👨&zwj;👩&zwj;👧&zwj;👧</button>
                                    ...
                                    <div class="h-full tab-content__pane" id="music">
                                        ...
                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                            <div class="grid grid-cols-8 text-2xl">
                                                ...
                                                <button class="rounded focus:outline-none hover:bg-gray-200">™️</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">#️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">*️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">0️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">1️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">2️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">3️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">4️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">5️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">6️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">7️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">8️⃣</button>
                                                <button
                                                    class="rounded focus:outline-none hover:bg-gray-200">9️⃣</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">🔟</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">💯</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">🔠</button>
                                                <button class="rounded focus:outline-none hover:bg-gray-200">🔡</button>
